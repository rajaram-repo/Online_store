...
my $upload_dir = '/home/jadrn047/public_html/proj1/imaaagee';
my $safe_filename_chars = "a-zA-Z0-9_.-";
####################################################################

my $q = new CGI;
# my $filename = $q->param('product_image_e');
# my $new_filename = $q->param('sku_e');
my $filename = $q->param('image_up');
...
# my $filename = "newimg.jpg";
# my $new_filename = "ABC-111";

# if ($new_filename == '') {
#     die "new_filename null";
# } else {
#     die "new_filename not null"
# }
...
my $filehandle = $q->upload("image_up"); 
