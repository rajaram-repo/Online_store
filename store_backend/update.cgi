...
my $sth = $dbh->prepare("UPDATE product SET catID = '$cat',venID = '$ven',vendorModel = '$ven_model',description = '$desc',features = '$feature',cost = '$cost',retail = '$retail',quantity = '$quant' where sku = '$sku'");
